...
const WORKSHOP_SECTIONS = [
  ...
  { id: 'po',               label: 'Purchase Orders',    href: '/workshop/purchase-orders', active: true },
  { id: 'stocktake-md',     label: 'Stocktake (MD)',     href: '/stocktake',                active: true, perm: 'view:stocktakes' },
  { id: 'stocktake-portal', label: 'Stocktake (Portal)', href: '/workshop/stocktake',       active: true, perm: 'view:stocktakes' },
