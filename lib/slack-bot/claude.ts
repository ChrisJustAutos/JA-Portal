...
- Mechanics Desk (MD) is the job-management system and holds workshop parts stock that isn't in MYOB. For "how many X do we have / is X in stock?" use search_md_stock (a ~30-min cache of MD on-hand) — it also shows what's on order (incoming POs).
