...
- Migrations live in `migrations/NNN_description.sql` (201 files, `002`–`201`; note `148` and `153` are each duplicated — sequence is a convention, not a key. Next number: **202**).
...
- Migrations `148` and `153` are duplicated numbers; latest applied is `201_jaws_stock_eom_slow_capital`, so next is `202`.
