...
| Refund / Approve order / Mark as paid / Delete order aren't on the order page | Those are admin-only, and as of 3 Sept 2026 they are hidden rather than shown-then-refused | Working as intended. Ask an admin, or have your role changed |
