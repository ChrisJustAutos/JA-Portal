...
import { A, RADIUS, SHADOW, AlloyStyles, btnStyle } from '../../../components/b2b/ui'
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {status === 'pending' && (
            <>
              <div style={{fontSize:17,fontWeight:650,marginBottom:6,letterSpacing:'-0.01em'}}>Signing you in…</div>
              <div style={{fontSize:13.5,color:T.text3}}>Verifying your magic link.</div>
            </>
          )}
          {status === 'success' && (
            <>
              <div style={{fontSize:17,fontWeight:650,marginBottom:6,letterSpacing:'-0.01em',color:A.good}}>Signed in</div>
              <div style={{fontSize:13.5,color:T.text3}}>Taking you to the catalogue…</div>
            </>
          )}
          {status === 'error' && (
            <>
              <div style={{fontSize:17,fontWeight:650,marginBottom:6,letterSpacing:'-0.01em',color:A.bad}}>Sign-in failed</div>
              <div style={{fontSize:13.5,color:T.text2,lineHeight:1.5,marginBottom:16}}>
                {error}
              </div>
              <a href="/b2b/login" style={{...btnStyle('primary', 'md'), textDecoration:'none'}}>
                Request a new link
              </a>
            </>
          )}
