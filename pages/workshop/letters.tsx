...
type Tab = 'history' | 'compose' | 'templates'
        ...
        <div style={{ flex: 1, overflowY: 'auto' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', padding: '24px 28px' }}>
            ...
            <p style={{ fontSize: 12.5, color: T.text3, margin: '0 0 16px' }}>
              ...
              {' '}The automation rule, letterhead, logo &amp; printers live in{' '}
              <a href="/workshop/settings?tab=letters" style={{ color: T.accent }}>Settings → Workshop → Thank-you letters</a>.
            </p>
