            ...
            : q ? (
              <>
                ...
                <div style={{ marginTop: 16 }}>
                  <MoreFields kind="quote" record={q} canEdit={canEdit} staff={staff} jobTypes={jobTypes}
                    onPatchRecord={patchQuote} onPatchCustomer={patchCustomer} onPatchVehicle={patchVehicle} />
                </div>
