...
const TABS: Array<{ id: string; label: string; href: string; perm: Permission }> = [
  ...
  { id: 'cash-count', label: 'Cash Count',    href: '/workshop/cash-count',     perm: 'view:diary' },
...
export default function InventoryTabs({ active, role }: { active: 'inventory' | 'live-bins' | 'cash-count' | 'prepick' | 'suppliers' | 'po' | 'stocktake' | 'stocktake2' | 'transfer'; role: UserRole }) {
