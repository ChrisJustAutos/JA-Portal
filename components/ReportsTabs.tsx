...
// Sub-tab strip for the Reports module: Reports · Distributors. Sits directly
// under the global top bar; each tab is gated by its own permission. Mirrors
// InventoryTabs / the CRM sub-tab strip.
...
export default function ReportsTabs({ active, role }: { active: 'reports' | 'distributors'; role: UserRole }) {
